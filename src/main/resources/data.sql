...
-- adding data to the project so that it doesn't get erased everytime we rerun the project
-- (since H2 is a temporary database) now goto the application.properties for another connecting configuration